// src/screens/CarePlusScreen.tsx
...
export default function CarePlusScreen() {
  ...
  if (showPlanDetails) {
    return (
      <View style={styles.container}>
        ...
        <View style={{ flex: 1, paddingBottom: insets.bottom }}>
          <WebViewContainer url="https://mpb.health/3d-flip-book/careplus/" />
        </View>
      </View>
    );
  }
  ...
  const benefits = [
    ...
    { title: 'Mental Health Support', icon: Brain, color: colors.secondary.main },
    { title: '24/7 Telehealth', icon: Phone, color: colors.primary.dark },
