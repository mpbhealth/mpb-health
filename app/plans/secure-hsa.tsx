// src/screens/SecureHSAScreen.tsx
  ...
  if (showPlanDetails) {
    return (
      <View style={screenChrome.container}>
        ...
        <View style={[styles.webviewWrapper, { paddingBottom: insets.bottom }]}>
          <WebViewContainer url="https://mpb.health/3d-flip-book/secure-hsa/" />
        </View>
      </View>
    );
  }

  // Non-clickable benefits
  const benefits = [
    ...
    { title: 'Mental Health Counseling', icon: Brain, color: colors.primary.dark },
    { title: 'Minimum Essential Coverage', icon: Heart, color: colors.secondary.dark },
    { title: 'Health Savings Account (HSA)', icon: Wallet, color: colors.primary.light },
    { title: 'Concierge Assistance', icon: MessageSquare, color: colors.secondary.light },
    { title: 'QR LifeCode & Records Vault', icon: FileText, color: colors.primary.main },
    { title: 'Discounts on Wellness Products', icon: Leaf, color: colors.secondary.main },
  ];
